...
extension NFXImage {
    class func NFXSettings() -> NFXImage {
        #if os (iOS)
        return UIImage(data: NFXAssets.getImage(NFXAssetName.settings), scale: 3.0)!
        #elseif os(OSX)
    ...
    class func NFXClose() -> NFXImage {
        #if os (iOS)
        return UIImage(data: NFXAssets.getImage(NFXAssetName.close), scale: 3.0)!
        #elseif os(OSX)
    ...
    class func NFXInfo() -> NFXImage {
        #if os (iOS)
        return UIImage(data: NFXAssets.getImage(NFXAssetName.info), scale: 3.0)!
        #elseif os(OSX)
    ...
    class func NFXStatistics() -> NFXImage {
        #if os (iOS)
        return UIImage(data: NFXAssets.getImage(NFXAssetName.statistics), scale: 3.0)!
        #elseif os(OSX)
